        ...
        <div class="col-md-6 offset-md-3 border p-4 shadow bg-light">
            ...
            <c:choose>
                <c:when test="${sessionScope.nom != null}">
                    ...
                    <div class="col-md-6">
                    <input type="text" class="form-control" value="${sessionScope.nom}" name="nomPatient" readonly>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="date" class="form-control" placeholder="Date du Rendez Vous" name="date">
                    </div>
                    <div class="col-md-6">
                ...
                <c:otherwise>
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="Nom" name="nomPatient">
                    </div>
                    <div class="col-md-6">
